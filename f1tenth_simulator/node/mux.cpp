...
public:
    Mux() {
        ...
        /// Add new channels here: remove tis part if somethig 
        // Evader driver example
        int evader_mux_idx;
        std::string evade_drive_topic;
        n.getParam("evade_drive_topic", evade_drive_topic);
        n.getParam("evader_mux_idx", evader_mux_idx);
        add_channel(evade_drive_topic, drive_topic, evader_mux_idx);
