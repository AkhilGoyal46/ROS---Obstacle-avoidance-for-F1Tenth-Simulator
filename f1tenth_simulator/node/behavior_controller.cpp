...
public:
    BehaviorController() {
        ...
        n.getParam("evade_button_idx", evade_button_idx);
        // ***Add button index for new planner here***
        ...
        n.getParam("evade_key_char", evade_key_char);
        // ***Add key char for new planner here***
    ...
    void joy_callback(const sensor_msgs::Joy & msg) {
        ...
        else if (msg.buttons[evade_button_idx]) { 
            // Evader
    ...
    void key_callback(const std_msgs::String & msg) {
        ...
        if (msg.data == joy_key_char) {
            ...
            // random walker
            toggle_mux(random_walker_mux_idx, "Random Walker");
        }else if (msg.data == evade_key_char) {
            // random walker
            toggle_mux(evader_mux_idx, "Evader");
        } 
